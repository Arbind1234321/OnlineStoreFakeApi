...
public class Routes {
	...
	public static final String GET_USER_CARTS_BY_DATE_RANGE = "/carts/user/{userId}?startdate={startdate}&enddate={enddate}";
	public static final String GET_CARTS_WITH_LIMIT = "/carts?limit={limit}";
	public static final String GET_CARTS_SORTED = "/carts?sort={sort}";
